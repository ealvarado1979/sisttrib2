$.extend($.validity.messages, {
    ...
    date: "invalido (dd/mm/yyyy)",
    email: "#{field} debe ser una dirección de email.",
    usd: "#{field} debe ser una cantidad en dólares USA.",
    url: "#{field} debe ser una dirección URL.",
    entero:"Número enteros",
    ...
    tooShort: "debe contener como mínimo #{min} caracteres.",
    ...
    maxCharClass: "no debe contener menos de #{min} caracteres #{charClass}.",
    ...
    generic: "No válido.",
//    minLength: "Debe de contener al menos #{min}"
});
